...
async def start_tournament():
    as_tsk_1=asyncio.create_task(start_strongman('Pasha', 3))
    as_tsk_2=asyncio.create_task(start_strongman('Denis', 4))
    as_tsk_3=asyncio.create_task(start_strongman('Apollon', 5))


    await as_tsk_1
    await as_tsk_2
    await as_tsk_3
    print('Соревнования завершены')
